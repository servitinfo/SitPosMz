...
public class ProductSalesReport extends Report {
    ...
    public ProductSalesReport(Context mContext) {
        super(mContext);
    ...
    protected void performReport() {
        productSales = new PosReportManagement(mContext).getProductSalesReportRows(fromDate, toDate);
    }
    ...
    protected void setReportResult() {
        ...
        if(productSales != null && !productSales.isEmpty()) {
            ...
            for(ReportGenericObject genericObject : productSales) {
